...
/**
 * Функция, реализующая алгоритм Евклида для НОД.
 */
fun euAlgo(m: Int, n: Int): Int {
    var a = m
    var b = n
    while(a > 0 && b > 0) {
 ...
 */
fun isCoPrime(m: Int, n: Int): Boolean = euAlgo(m,n) == 1
...
fun squareSequenceDigit(n: Int): Int {
    ...
    for (i in 1..n)  {
            ...
            a = s - n
            if (a >= 0) {
                b = (n1 / Math.pow(10.0, a.toDouble()).toInt()) % 10
                break
            }
    }
    return b
